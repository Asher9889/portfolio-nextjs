    ...
    return (
      <main className="bg-w-bg font-inter min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/services" className="text-sm text-w-blue hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-w-blue/50 rounded-sm">
            Back to Services
          </Link>
        </div>
      </main>
